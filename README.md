...
- A relational Database is a collection of tables, most of which relate to each other. SQL is the language used to run CRUD operations on the database.

2. Why do tables need a `primary key`?

- Tables need a way to uniquely identify every record in a permanent way.
...
- We need a third table between them that can then carry one to many relationships with the original tables.
